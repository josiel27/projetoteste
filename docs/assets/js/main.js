...
function scrollFunction() {
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    ...
    //   document.getElementById("navbar").style.background = "rgba(26, 10, 56, 0.93)"; //roxo
      document.getElementById("navbar").style.background = "rgba(0, 0, 0, 0.95)";
      
  } else {
    document.getElementById("navbar").style.top = "0px";
    // document.getElementById("navbar").style.background = "rgba(26, 10, 56, 0.73)"; //roxo
    document.getElementById("navbar").style.background = "rgba(0, 0, 0, 0.67)";
  }
}